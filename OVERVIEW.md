...
**Headline result:** A typical 5-source research task uses **71 % fewer tokens** with Plynf than without — measured precisely, reproducible offline, three different topics. That's not a theoretical claim, it's in the repo as a runnable demo.
